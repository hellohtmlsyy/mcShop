          ...
          <section>
            <Header-card title="联系我们" class="bd">
              ...
              <div  class='qrcode-box' >
                <div class="qrcode">
                  <qriously :value="qrcodeConfig.href" :size="165" />
                  <div class="img-box">
                    <img :src="baseInfoData.logo" alt="" width="40" height="40">
                  </div>
                </div>
                <p>扫一扫进入手机旺铺</p>
              </div>
...
export default {
  ...
  mounted(){
    this.qrcodeConfig.href = 'http://m.miningcircle.com/flagship?newpage=newpage&shopId=' + this.shopId
  },
  computed: {
